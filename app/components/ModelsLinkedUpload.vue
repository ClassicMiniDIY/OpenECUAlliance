        ...
        <template v-if="fetchedMetadata && !fetching">
          ...
          <UFormField label="Model Name" required class="w-full">
            ...
            <template #description>
              <span class="text-xs"
                >You can edit the name from the original source.</span
              >
            </template>
          </UFormField>
          ...
          <div class="p-4 rounded-lg bg-elevated border border-default">
            ...
            <div class="grid sm:grid-cols-3 gap-4 text-sm">
              ...
              <div>
                ...
                <p class="font-medium">
                  <span
                    v-if="fetchedMetadata.remixesAllowed"
                    class="text-success"
                    >Allowed</span
                  >
              ...
              <div>
                ...
                <p class="font-medium">
                  <span
                    v-if="fetchedMetadata.commercialUseAllowed"
                    class="text-success"
                    >Allowed</span
                  >
                  <span v-else class="text-error">Not allowed</span>
          ...
          <div class="p-4 rounded-lg bg-elevated border border-default">
            ...
            <div class="grid sm:grid-cols-3 gap-4 text-sm">
              ...
              <div>
                ...
                <p class="font-medium">
                  {{
                    formatPrintSetting(
                      fetchedMetadata.printSettings?.layerHeight,
                      "mm",
                    )
                  }}
                </p>
              ...
              <div>
                ...
                <p class="font-medium">
                  {{
                    formatPrintSetting(
                      fetchedMetadata.printSettings?.infillPercent,
                      "%",
                    )
                  }}
                </p>
              ...
              <div
                v-if="
                  fetchedMetadata.printSettings?.supportsRequired !== undefined
                "
              >
                <p class="text-muted text-xs mb-1">Supports</p>
                <p class="font-medium">
                  <span
                    v-if="fetchedMetadata.printSettings.supportsRequired"
                    class="text-warning"
                    >Required</span
                  >
            ...
            <p class="text-xs text-muted mt-3">
              Print settings are imported from the original source.
            </p>
          </div>
        </template>
      </div>

...
<template>
  <div class="space-y-6">
    ...
    <div v-if="isAuthenticated" class="border-t border-muted/20 pt-4">
      <div v-if="userRating" class="flex items-center justify-between">
        ...
        <div class="flex gap-2">
          <UButton size="sm" variant="ghost" @click="openReviewForm">
            Edit
          </UButton>
          <UButton
            size="sm"
      ...
      <UButton v-else variant="outline" @click="openReviewForm">
        Rate this model
      </UButton>
    </div>
        ...
        <div class="p-6">
          ...
          <div class="space-y-4">
            ...
            <div class="flex justify-end gap-2">
              <UButton variant="ghost" @click="closeReviewForm">
                Cancel
              </UButton>
              <UButton
                :loading="submitting"
    ...
    <!-- Reviews List -->
    <div
      v-if="ratingsWithReviews.length > 0"
      class="border-t border-muted/20 pt-4"
    >
      <h4 class="font-medium mb-4">
        Reviews ({{ ratingsWithReviews.length }})
      </h4>

      <div class="space-y-4">
        <div
          v-for="rating in ratingsWithReviews"
          :key="rating.userId"
          class="flex gap-3"
        >
          ...
          <div class="flex-1">
            <div class="flex items-center gap-2">
              <NuxtLink
                :to="`/users/${rating.author.username}`"

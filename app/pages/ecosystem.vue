    ...
    <UContainer class="py-12">
      ...
      <div class="text-center max-w-3xl mx-auto mb-12">
        ...
        <p class="text-lg text-muted">
          Applications and libraries built with OpenECU Spec support.
        </p>
      </div>
      ...
      <UCard class="text-center">
        <div class="py-6">
          ...
          <p class="text-muted mb-4 max-w-lg mx-auto">
            If your application uses OpenECU Spec adapters, protocols, or
            models, we'd love to feature it here.
          </p>

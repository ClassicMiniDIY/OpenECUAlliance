...
<template>
  <div>
    <UContainer class="py-12">
      ...
      <!-- Models Grid -->
      <div v-else-if="models.length > 0" class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <UCard
        ...
        >
          <!-- Image -->
          <div class="aspect-video bg-elevated rounded-lg overflow-hidden mb-4 -mx-4 -mt-4">
            <img
          ...
          <div class="flex items-center gap-2 mb-3">
            ...
            >
              {{ (model.author.displayName || model.author.username).substring(0, 1).toUpperCase() }}
            </div>
      ...
      <UCard v-else class="text-center py-12">
        <UIcon name="i-heroicons-heart" class="size-16 text-muted mx-auto mb-4" />
        <h3 class="font-semibold mb-2">No liked models yet</h3>
        <p class="text-muted mb-4">Browse models and click the heart to save them here.</p>

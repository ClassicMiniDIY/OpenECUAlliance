...
useSeoMeta({
  ...
  description:
    "Sign in to OpenECU Alliance to upload 3D models, track favorites, and engage with the community.",
});
    ...
    <div class="w-full max-w-md">
      ...
      <div class="text-center mb-8">
        ...
        <p class="text-muted mt-2">
          Sign in to upload models, save favorites, and engage with the
          community.
        </p>
      </div>
      ...
      <UCard v-if="emailSent" class="text-center">
        <div class="py-4">
          <div
            class="size-16 mx-auto mb-4 bg-success/10 rounded-full flex items-center justify-center"
          >
          ...
          <UButton variant="ghost" @click="resetEmailForm">
      ...
      <UCard v-else>
        ...
        <p class="text-xs text-muted text-center mt-6">
          ...
          <NuxtLink to="/docs/terms" class="text-primary hover:underline"
            >Terms of Service</NuxtLink
          >
          and
          <NuxtLink to="/docs/privacy" class="text-primary hover:underline"

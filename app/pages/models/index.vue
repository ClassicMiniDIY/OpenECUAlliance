    ...
    <UContainer class="py-12">
      ...
      <div class="text-center max-w-3xl mx-auto mb-12">
        ...
        <p class="text-lg text-muted mb-8">
          Browse 3D printable ECU mounts, enclosures, brackets, and accessories.
          Download files with recommended print settings.
        </p>
      ...
      >
        <UIcon
          ...
          class="size-8 text-warning animate-spin mb-4"
        />

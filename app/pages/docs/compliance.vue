...
useSeoMeta({
  ...
  description:
    "Understanding Level 1-3 compliance for OpenECU Spec applications.",
});
      ...
      <section class="mb-12">
        ...
        <UCard>
          <p class="text-muted mb-4">
            The OpenECU Spec defines a standard format for describing ECU log
            file formats. Applications that implement this specification can
            advertise their compliance level, helping users understand what to
            expect.
          </p>
      ...
      <section class="mb-12">
        ...
        <div class="space-y-4">
          ...
          <UCard>
            ...
            <p class="text-sm text-muted">
              Self-certification is acceptable for Levels 1-2. Level 3 and
              "Certified" require formal review.
            </p>
          </UCard>
        </div>
      </section>

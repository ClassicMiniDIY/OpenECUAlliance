...
const roles = [
  ...
  },
  {
    ...
    composition:
      "Nominated by existing Maintainers, approved by Steering Committee",
    ...
    <UContainer class="max-w-4xl">
      ...
      <div class="mb-8">
        ...
        <p class="text-lg text-muted">
          How the OpenECU Alliance operates, makes decisions, and evolves the
          specification.
        </p>
      </div>
      ...
      <section class="mb-12">
        ...
        <UCard>
          <p class="text-muted">
            ...
            ECU log data formats and building an ecosystem of interoperable
            automotive tools. The Alliance maintains the OpenECU Spec and
            coordinates development of Alliance Projects.
          </p>
        </UCard>
      </section>
      ...
      <section class="mb-12">
        ...
        <div class="space-y-4 mb-8">
          <UCard v-for="role in roles" :key="role.name">
            <div class="flex items-start gap-4">
              <div
                class="flex items-center justify-center size-12 bg-primary/10 text-primary rounded-xl shrink-0"
              >
        ...
        <UCard>
          <p class="text-muted mb-4">
            Working Groups may be formed for specific focus areas and are
            created by Steering Committee approval.
          </p>
          <div class="space-y-3">
            <div
        ...
        <div class="space-y-6">
          ...
          <UCard>
            ...
            >
              ...
              <li>
                If no objections after the review period, the proposal is
                accepted
              </li>
              <li>
                If objections exist, discussion continues until consensus is
                reached
              </li>
            </ol>
          ...
          <UCard>
            ...
            <p class="text-muted mb-4">
              When consensus cannot be reached, decisions may go to a vote. Only
              Maintainers and Steering Committee members may vote on formal
              matters.
            </p>
            <div class="space-y-2">
              <div
                v-for="vote in votingTypes"
                :key="vote.type"
          ...
          <UCard>
            ...
            <p class="text-muted mb-4">
              Significant changes to the specification follow the RFC (Request
              for Comments) process:
            </p>
            <div class="space-y-3">
              <div
                v-for="(step, index) in rfcSteps"
                :key="step.step"
      ...
      <section class="mb-12">
        ...
        <UCard>
          ...
          <p class="text-sm text-muted">
            Features may be deprecated with at least one minor version of
            warning. Warning period of at least 6 months before removal in next
            major version.
          </p>
        </UCard>
      </section>
        ...
        <div class="space-y-4">
          ...
          <UCard>
            ...
            <p class="text-muted mb-3">
              Adapters in this repository are owned by the Alliance, not
              individual contributors. This ensures:
            </p>
      ...
      <section class="mb-12">
        ...
        <UCard>
          <p class="text-muted mb-4">
            All participants must adhere to the Code of Conduct. Enforcement
            decisions are made by the Steering Committee.
          </p>
          <h4 class="font-semibold mb-2">Enforcement Levels:</h4>
          <div class="space-y-2">
            <div
              v-for="level in enforcementLevels"
              :key="level.level"
      ...
      <section class="mb-12">
        ...
        <UCard>
          <p class="text-muted">
            This governance document may be amended through the RFC process with
            a supermajority vote of the Steering Committee.
          </p>
        </UCard>
      </section>
      ...
      <div class="flex flex-col sm:flex-row gap-4">
        <UButton to="/contribute" icon="i-heroicons-hand-raised" size="lg">
          Get Involved
        </UButton>
        <UButton

...
async function fetchData() {
  ...
  try {
    ...
    images.value = (imagesData || []).map((i: any) => ({
      ...i,
      url: supabase.storage.from("model-images").getPublicUrl(i.storage_path)
        .data.publicUrl,
    }));
  } catch (err) {
...
async function handleApprove() {
  const success = await approveModel(
    queueId.value,
    model.value.id,
    approveNotes.value,
  );
...
async function handleReject() {
  ...
  const success = await rejectModel(
    queueId.value,
    model.value.id,
    rejectReason.value,
  );
    ...
    <UContainer class="py-12">
        ...
        <div class="grid lg:grid-cols-3 gap-6">
          ...
          <div class="lg:col-span-2 space-y-6">
            ...
            <UCard>
              ...
              <p v-else class="text-center py-8 text-muted">
                No images uploaded
              </p>
            </UCard>
            ...
            <UCard v-if="model.printing">
              ...
              <div class="grid sm:grid-cols-2 gap-4">
                ...
                <div v-if="model.printing.supports_required !== undefined">
                  ...
                  <p class="font-medium">
                    {{
                      model.printing.supports_required
                        ? "Required"
                        : "Not required"
                    }}
                  </p>
          ...
          <div class="space-y-6">
            ...
            <UCard>
              ...
              <UButton
                :to="`/users/${model.profiles.username}`"
                variant="outline"
                size="sm"
                class="mt-4 w-full"
              >
      ...
      <UCard v-else class="text-center py-12">
        <UIcon
          ...
          class="size-16 text-error mx-auto mb-4"
        />
        <h2 class="font-semibold mb-2">Item Not Found</h2>
        <p class="text-muted mb-4">
          This queue item doesn't exist or has been removed.
        </p>
        ...
        <template #content>
          <UCard>
            <template #header>
              <div class="flex items-center gap-3">
                <div
                  class="size-10 rounded-full bg-success/10 flex items-center justify-center"
                >
            ...
            <template #footer>
              <div class="flex justify-end gap-2">
                <UButton variant="ghost" @click="showApproveModal = false">
                  Cancel
                </UButton>
                <UButton
                  color="success"
        ...
        <template #content>
          <UCard>
            <template #header>
              <div class="flex items-center gap-3">
                <div
                  class="size-10 rounded-full bg-warning/10 flex items-center justify-center"
                >
                  <UIcon
            ...
            <p class="text-muted mb-4">
              Describe what changes are needed. The author can resubmit after
              making updates.
            </p>
            ...
            <template #footer>
              <div class="flex justify-end gap-2">
                <UButton variant="ghost" @click="showChangesModal = false">
                  Cancel
                </UButton>
                <UButton
                  color="warning"
